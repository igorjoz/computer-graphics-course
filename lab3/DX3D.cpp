...
HRESULT InitDevice()
{
	...
	SimpleVertex vertices[] =
	{
        // FRONT
        // lower leg
		{ XMFLOAT3(0.7f, 0.0f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(0.9f, 1.0f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(0.7f, 1.0f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },

        { XMFLOAT3(0.9f, 0.0f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.7f, 0.0f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.9f, 1.0f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },

        // middle
        { XMFLOAT3(0.7f, 0.6f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.7f, 0.8f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f, 0.6f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },

        { XMFLOAT3(0.0f, 0.8f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f, 0.6f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.7f, 0.8f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },

        // upper
        { XMFLOAT3(0.0f, 0.8f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.2f, 0.8f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.2f, 1.3f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },

        { XMFLOAT3(0.2f, 0.8f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.4f, 1.3f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.2f, 1.3f, zFront), XMFLOAT3(0.0f, 0.0f, 1.0f) },


        // BACK
        // lower leg
        { XMFLOAT3(0.7f, 0.0f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.9f, 1.0f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.7f, 1.0f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },

        { XMFLOAT3(0.9f, 0.0f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.7f, 0.0f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.9f, 1.0f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },

        // middle
        { XMFLOAT3(0.7f, 0.6f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.7f, 0.8f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f, 0.6f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },

        { XMFLOAT3(0.0f, 0.8f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f, 0.6f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.7f, 0.8f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },

        // upper
        { XMFLOAT3(0.0f, 0.8f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.2f, 0.8f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.2f, 1.3f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },

        { XMFLOAT3(0.2f, 0.8f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.4f, 1.3f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.2f, 1.3f, zBack), XMFLOAT3(0.0f, 0.0f, 1.0f) },
    ...
    g_nVertices = sizeof(vertices) / sizeof(SimpleVertex);
...
void Render()
{
    ...
    //g_World = g_World * XMMatrixTranslation(0.0, 0.0, 2.0);
    ...
    XMFLOAT4 vLightColors2 = XMFLOAT4(0.8f, 0.2f, 0.3f, 1.0f);
    ...
    //cb1.mWorld = XMMatrixTranslation(g_World);
    ...
    ConstantBuffer cb2;
    // gWord = gWworld * Translation
    cb2.mWorld = XMMatrixTranspose(g_World * XMMatrixTranslation(-1.3, -0.3, -1.0));
